            ...
            async (err, results) => {
                ...
                new ButtonBuilder()
                    ...
                    await interaction.update({
                        ...
                        content: '🎉 Kanał został ustawiony jako publiczny.',
                    });
                } catch (error) {
                    console.error('Błąd przy ustawianiu kanału jako publicznego:', error);
                    return await interaction.reply({
                        content: 'Wystąpił błąd podczas ustawiania kanału jako publicznego.',
                        flags: 64,
                    });
                }
            }
